  ...
  return (
    <div className="book">
      <div className="book-image-container">
        <img src={'https://cdn.shopify.com/s/files/1/0592/0695/9288/products/EPS_Micellar_WebNew_568x756.jpg?v=1632175208'} alt="Book Cover" />
      </div>
      <div className="book-details-container">
        ...
        <Button 
        style={{width:'500px', height:'48px', border:'1px solid black', backgroundColor:'Black', fontSize: '24px'}}
        type="primary">Thêm vào giỏ hàng</Button>
